...
{
    public static final Color[] hatColors = {new Color(169, 149, 14), new Color(177, 164, 74), new Color(136, 104, 10), new Color(96, 46, 9)};
    public static final Color[] faceColors = {new Color(212, 166, 123),new Color(147, 110, 75), new Color(194, 145, 99)};
    public static final Color[] eyeColors = {new Color(153, 229, 80), new Color(225, 225, 225), new Color(56, 37, 17)};
    ...
    public static final int vWidth = 15;
    public static final int vHeight = 29;
